...
class wrap_shape(object):
    ...
    def set_size(self):
        self.size = (int((self.xmax-self.xmin)/0.5),
    ...
    def create_outputfile(self, layer_name, path_name):
        ...
        self.out_layer = self.out_datasource.CreateLayer(layer_name, 
                                                          self.sr, 
                                                          self.geom_type)
        for i in range(self.layer_defn.GetFieldCount()):
    ...
    def copy_datasource(self, out_layer):
        ...
        self.out_datasource = DRIVER_OGR_SHP.CopyDataSource(self.datasource,
                                                            out_layer)
    ...
    def get_geom_transform(self, out_epsg=28992):
        ...
        coordTrans = osr.CoordinateTransformation(self.sr, 
                                                  out_spatial_ref)
    ...
    def write_geometries(self, layer_name, path_name):
        try:
            ...
            out_layer = data_source.CreateLayer(layer_name, 
                                                self.sr, 
                                                self.geom_type)
