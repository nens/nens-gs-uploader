...
class wrap_atlas:
    def __init__(self, atlas_name):
        ...
        self.atlassen =[
            "wpn", "zundert", "westland", "wdodelta", "velsen",
            "schiedam", "rijswijk", "rijnland", "purmerend", "polder",
             "oss", "middelburg", "mra", "meerdijk", "maastricht",
             "lv",  "zuid-holland", "houten",
            "haarlemmermeer", "hhnk", "groningen", "etten",
            "denhaag", "delfland", "capelleaandenijssel", "bluelabel",
            "alphenaandenrijn", "almere", "alkmaar", "a5h", "agv"
            ]
